...
만화 느낌이 잘 표현되는 이미지는 다음과 같은 특성을 가진 경우입니다:

- **명확한 윤곽선**: 피사체와 배경의 경계가 뚜렷한 이미지
- **균일한 색상 영역**: 단색에 가까운 넓은 면적이 있는 이미지 (예: 하늘, 벽)
- **적절한 대비**: std 50~70 수준의 이미지

| 원본 | 만화 변환 결과 |
|:---:|:---:|
| ![원본1](image/1.jpeg) | *(결과 이미지)* |
...
만화 느낌이 잘 표현되지 않는 이미지는 다음과 같은 특성을 가집니다:

- **복잡한 배경**: 나뭇잎, 잔디, 군중 등 세밀한 텍스처가 많은 이미지
- **낮은 대비**: 안개, 흐린 날씨 등 전체적으로 뿌연 이미지
- **불균일한 조명**: 역광이나 강한 그림자로 같은 피사체 내 명암 차이가 극심한 경우

| 원본 | 만화 변환 결과 |
|:---:|:---:|
| ![원본2](image/5.jpeg) | *(결과 이미지)* |
